...
import { ApiResponse, BookDoc, Book } from "../models/Book.js";
...
export class BookService extends BaseService {
  ...
  public async searchBooks(query: string, limit: number = 10): Promise<Book[]> {
    const url = this.buildUrl("/search.json", {
      ...
      fields: "key,title,author_name,first_publish_year,cover_i,subject,number_of_pages_median,ratings_average",
    });
