...
template.innerHTML=`
        <style>
            ...
            .card__bio-name {height:fit-content;}
            .card__bio-top-work {height:fit-content;}
            .card__bio-birth-year {height:fit-content;}
        </style>
...
export default class authorCard extends HTMLElement {
    static get observedAttributes(){
        return ['name','top-work','birth-year','photo-url']
    };
    constructor() {
        super();
